      ...
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          <div className='flex items-center gap-3 shadow-card border border-violet-700 p-4 w-66 rounded-md'>
            <img src="../asset/patients_icon.svg" alt="" />
            <div>
          ...
          <div className='flex items-center gap-3 shadow-card border border-violet-700 p-4 w-66 rounded-md'>
            <img src="../asset/appointments_icon.svg" alt="" />
            <div>
          ...
          <div className='flex items-center gap-3 shadow-card border border-violet-700 p-4 w-66 rounded-md'>
            <img src="../asset/earning_icon.svg" alt="" />
            <div>
              ...
              <tbody className='text-sm text-gray-500'>
                {dashboardData.enrolledStudentsData.map((item,index)=>(
                  <tr key={index} className='border-b border-gray-500/20'>
                    ...
                    <td className='md:px-4 px-2 py-3 felx items-center space-x-3'>
